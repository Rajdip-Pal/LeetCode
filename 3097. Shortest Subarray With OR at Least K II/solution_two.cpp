...
class Solution
{
    std::string performe_or(const std::string &op1, const std::string &op2, std::unordered_map<int, int> &set_unset_record)
    {
    ...
    std::string performe_reverse_or(const std::string &op1, const std::string &op2, std::unordered_map<int, int> &set_unset_record)
    {
...
public:
    ...
    int minimumSubarrayLength(const std::vector<int> &nums, const int &k)
    {
        ...
        std::unordered_map<int, int> set_unset_record;
